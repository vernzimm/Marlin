...
#define STRING_CONFIG_H_AUTHOR "(VZ, port from V2.2.9/M1.1.9.2)" // Original author or contributor.
...
#define CUSTOM_MACHINE_NAME "Maker Ultimate 2"
 ...
 */
  ...
  #define MPC_BLOCK_HEAT_CAPACITY { 8.580f }          // (J/K) Heat block heat capacities.
  #define MPC_SENSOR_RESPONSIVENESS { 0.252f }        // (K/s per ∆K) Rate of change of sensor temperature from heat block.
  #define MPC_AMBIENT_XFER_COEFF { 0.031f }           // (W/K) Heat transfer coefficients from heat block to room air with fan off.
  #if ENABLED(MPC_INCLUDE_FAN)
    #define MPC_AMBIENT_XFER_COEFF_FAN255 { 0.054f }  // (W/K) Heat transfer coefficients from heat block to room air with fan on full.
  #endif
...
#define Z_MIN_ENDSTOP_HIT_STATE LOW //manuf file was set True, relates to probe?
 ...
 *                                      X, Y, Z [, I [, J [, K...]]], E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_FEEDRATE          { 300, 300, 20, 35 } //manuf file has this as 5000 each??
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { 41, 52, -0.5 } // (mm) X, Y, Z distance from Nozzle tip to Probe trigger-point
...
#define Z_PROBE_LOW_POINT          -2 // (mm) Farthest distance below the trigger-point to go before stopping
                                      //manuf file has -11... seems... dangerous, but probably because Z-probe offset was not
                                                        //set correctly.
...
//#define Z_MIN_PROBE_REPEATABILITY_TEST
  //I did use this... remarkably 0.006mm, fantastic
...
#define FILAMENT_RUNOUT_SENSOR //Manuf file had special "EnableRunoutAndDoor" that was defined, and caused FRS to be defined
                               //but no mention of door anywhere. Do they possibly share the same circuit? No, seems like
                               //the door sensor code was unique to Weedo. Not a big deal.
  ...
  //#define FILAMENT_RUNOUT_SCRIPT "M600" MPCedit
...
//#define AUTO_BED_LEVELING_UBL MPCedit
...
/**
 * Auto-leveling needs preheating (not necessary if PREHEAT_BEFORE_PROBING is enabled)
 */
...
//#define DEBUG_LEVELING_FEATURE
  ...
  //#define ENABLE_LEVELING_FADE_HEIGHT
    ...
    #define DEFAULT_LEVELING_FADE_HEIGHT 20 // (mm) Default fade height.
  #endif
...
#define DISABLE_M503        // Saves ~2700 bytes of flash. Disable for release! MPCedit
