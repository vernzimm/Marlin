...
#define FAN0_PIN                               9 //part cooler fan
#define E0_AUTO_FAN_PIN                        7 //extruder cooler fan

//
// Misc. Functions
//
//#define LED_PIN                             13  //doesn't seem to work
#define FIL_RUNOUT_PIN                         3
//#define DOOROPEN_PIN                        40  //from manuf file, not implemented in Marlin
#define Z_MIN_PROBE_PIN                       18  //manuf file had this as 32?
